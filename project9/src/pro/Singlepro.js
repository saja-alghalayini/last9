...
function Single(){
    ...
    const gitData = () => {
      axios.get(`http://localhost/last9/porject9/php/singlePro.php?id=` + params.id)
        .then((res) => {
    ...
    const getauc = () => {
      axios.get(`http://localhost/last9/porject9/php/numberAuc.php?pro_id=` + params.id)
        .then((res) => {
    ...
    const gitMix = () => {
      axios.get(`http://localhost/last9/porject9/php/maxPrice.php?pro_id=` + params.id)
        .then((res) => {
    ...
    useEffect(() => {
      ...
      if (daydiff > 0) {
        ...
        if (parseInt(inf.min_price) < parseInt(submit)) {
          document.getElementById('bid').style.display = 'block';
          let id = params.id
          axios.post('http://localhost/last9/porject9/php/updatePrice.php?id=' + params.id + '&price=' + submit)
            .then(() => {
              console.log("success!", submit, params.id);
  
            });
          axios.post('http://localhost/last9/porject9/php/addAuc.php?user_id=' + user_id + '&price=' + submit + '&pro_id=' + id)
            .then(() => {
        ...
        axios.post('http://localhost/last9/porject9/php/updateSold.php?id=' + params.id + '&user_id=' + max_user)
          .then(() => {
